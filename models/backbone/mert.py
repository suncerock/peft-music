"""
MERT model configuration and MERT model definition

Copy pasted from
https://huggingface.co/m-a-p/MERT-v1-95M/blob/main/configuration_MERT.py
https://huggingface.co/m-a-p/MERT-v1-95M/blob/main/modeling_MERT.py
"""
